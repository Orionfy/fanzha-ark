...
INTENT_PATTERNS: Final[tuple[tuple[Intent, tuple[str, ...]], ...]] = (
    ("alert", (r"报警", r"110", r"派出所", r"警察", r"96110", r"举报", r"报警了", r"报网警", r"反诈中心")),
    ("expose", (r"骗子", r"诈骗", r"套路", r"剧本", r"杀猪盘", r"刷单都是骗", r"骗人", r"你骗", r"别骗", r"骗我", r"假的吧", r"骗局", r"哄人", r"想骗", r"忽悠", r"割韭菜", r"上钩", r"真会编", r"接着编", r"继续编", r"戏真多", r"演的", r"装的", r"装得", r"编得", r"演得", r"套路深", r"影帝", r"呵呵", r"笑死")),
    ("refuse", (r"不要", r"不需要", r"不用", r"再见", r"拉黑", r"没兴趣", r"别烦", r"滚", r"不聊", r"算了", r"不了", r"退出", r"删除", r"卸载", r"烦不烦", r"免了", r"拜拜", r"不奉陪", r"别浪费")),
    ("suspect", (r"真的假", r"怎么证明", r"凭什么", r"为什么", r"可靠", r"正规", r"验证", r"官网", r"核实", r"公司", r"执照", r"实名", r"安全", r"放心", r"靠谱", r"信任", r"查一下", r"太假", r"不合理", r"漏洞", r"平台", r"资质", r"官方", r"工号", r"身份", r"求证", r"查证", r"核对", r"截图", r"凭证", r"渠道", r"退款", r"咨询", r"求助", r"朋友", r"家人", r"回拨", r"不信", r"离谱", r"怀疑", r"不对劲")),
    ("stall", (r"等等", r"再想", r"考虑", r"明天", r"晚点", r"以后", r"再说", r"问问", r"商量", r"忙", r"先放一放", r"回头", r"改天", r"过两天", r"缓缓", r"放放")),
    ("comply", (r"转账", r"汇款", r"打钱", r"付款", r"扫码", r"下载", r"注册", r"垫付", r"操作", r"任务", r"链接", r"填写", r"验证码", r"卡号", r"密码", r"收款", r"打款", r"转给", r"发我", r"输入")),
)
